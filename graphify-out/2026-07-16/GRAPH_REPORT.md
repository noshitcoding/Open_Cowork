...
## Corpus Check
- 317 files · ~331,512 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5088 nodes · 12763 edges · 228 communities (203 shown, 25 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 94 edges (avg confidence: 0.72)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `a7981ae0`
...
### Community 0 - "Result"
Cohesion: 0.04
Nodes (155): CredentialStore, Default, ArtifactExportRow, authorize_worker_sandbox_source(), backend_delete(), backend_ensure_local(), backend_exec(), backend_list() (+147 more)
...
Cohesion: 0.04
Nodes (53): baseAgent, hasTauriRuntimeMock, safeInvokeMock, navigateMock, ModelSwitcher(), DEFAULT_PERSONALITY_ICONS, EMPTY_FORM, formatRoleLabel() (+45 more)

### Community 3 - "registry.ts"
Cohesion: 0.03
Nodes (70): agentTool, askUserTool, AskUserToolInput, bashTool, copyPathTool, createDirectoryTool, deleteFileTool, DesktopActionResponse (+62 more)
...
Cohesion: 0.03
Nodes (122): appendStoppedAssistantContent(), AskUserOption, AskUserPromptModel, buildChatExportPayload(), buildEngineUserInput(), buildProjectInstructionsPromptContext(), buildProjectLinkPromptContext(), ChatExportFormat (+114 more)
...
### Community 10 - "Option"
Cohesion: 0.05
Nodes (101): TaskCreatePanel(), TaskCreatePanelProps, TaskDetailPane(), TaskDetailPaneProps, TaskProjectContext, TaskListPane(), TaskListPaneProps, baseTask (+93 more)

### Community 11 - "tr"
Cohesion: 0.14
Nodes (5): CrewRuntimeComplexIntegrationTests, CrewRuntimeIntegrationTests, CrewRuntimeParallelIntegrationTests, CrewRuntimeStatusTests, CrewRuntimeToolTests
...
Cohesion: 0.09
Nodes (50): streamMessages(), PermissionDecision, getAllTools(), accumulateUsage(), AgentToolProgress, AssistantMessage, AttachmentMessage, BashProgress (+42 more)
...
Cohesion: 0.10
Nodes (27): AddProjectResourceInput, addUniqueResources(), DbProject, DbProjectResource, DeleteProjectOptions, generateId(), getLegacyFallbackProjects(), normalizeProject() (+19 more)
...
Cohesion: 0.11
Nodes (44): agent_display_name(), build_agent(), build_artifact_repair_description(), build_governance_note(), build_llm(), build_memory_note(), build_task_description(), classify_runtime_error() (+36 more)
...
Cohesion: 0.17
Nodes (21): normalizeSessions(), normalizeSessionSummary(), SessionLike, SessionSearchPanel(), toNumber(), clipText(), createFallbackUuid(), hydrateStoredMessage() (+13 more)
...
Cohesion: 0.12
Nodes (17): type, type, type, type, properties, accessibility, enabled_when, handler (+9 more)

### Community 30 - "chatStore.ts"
Cohesion: 0.04
Nodes (95): active_toolset_inference_detects_custom_edits(), backend_file_mutations_respect_the_active_toolset_policy(), build_policy_tool_states(), build_toolset_policy(), canonical_policy_tool_id(), command_contains_path_traversal(), configure_pdfium_search_paths(), crew_stop() (+87 more)
...
Cohesion: 0.06
Nodes (34): sessionRecord, sessionSummary, getAllCommands(), EngineBackend, EngineEvent, CrewTaskMessageParams, autoSaveSession(), createSession() (+26 more)
...
Cohesion: 0.08
Nodes (20): BashTool, CopyPathTool, CreateDirectoryTool, EditFileTool, GlobTool, GrepTool, MovePathTool, OfficeWorkflowTool (+12 more)
...
Cohesion: 0.05
Nodes (61): ArtifactVersionRow, build_exec_command_text(), chat_turn(), chat_turn_stream(), ChatTurnRequest, crew_runs_list(), CrewRunHistoryRow, db_save_task() (+53 more)
...
Cohesion: 0.14
Nodes (21): _agent_access(), BashInput, build_runtime_tools(), _canonical_tool_id(), EditFileInput, _fetch_public_text(), GlobInput, GrepInput (+13 more)
...
Cohesion: 0.04
Nodes (57): ExternalProviderHealthCheckResult, ExternalProviderModelsResult, isLlmProviderKind(), LlmProfilesPanel(), modelSuffix(), parseNumericInput(), ProfileHealthState, ProfileModelsState (+49 more)
...
Cohesion: 0.15
Nodes (23): apply_provider_headers(), build_provider_chat_urls(), build_provider_model_urls(), connector_test_reachability(), ConnectorReachabilityRequest, ConnectorReachabilityResponse, crew_provider_health_check(), CrewProviderHealthCheckRequest (+15 more)
...
Cohesion: 0.04
Nodes (49): devDependencies, autoprefixer, @axe-core/playwright, eslint, @eslint/js, eslint-plugin-react-hooks, eslint-plugin-react-refresh, globals (+41 more)
...
Cohesion: 0.05
Nodes (17): CrewApprovalRow, CrewDefinitionRow, CrewRoleBindingRow, CrewRunEventRow, Database, delete_work_task_removes_matching_schedule(), map_worker_sandbox_row(), MemoryEntryRow (+9 more)
...
Cohesion: 0.09
Nodes (42): aggregate_gateway_status(), build_local_gateway_subsystems(), check_audit_writable(), claude_code_send_stream(), crew_approval_resolve(), CrewApprovalResolveRequest, document_render_preview(), enforce_file_tool_policy() (+34 more)
...
Cohesion: 0.05
Nodes (50): App(), AppRoutes(), BackendPolicyState, confirmAppClose(), CoworkView, CrewView, FeaturesView, hasRunningWork() (+42 more)
...
Cohesion: 0.09
Nodes (37): add_column_if_missing(), audit_event_insert(), configure_connection(), connection_pragmas_enforce_integrity_and_contention_policy(), corrupt_database_files_and_invalid_data_directories_are_rejected(), create_pre_migration_backup(), current_schema_version(), database_error() (+29 more)
...
Cohesion: 0.08
Nodes (23): CATEGORIES, CategoryKey, EMPTY_GATEWAY_HEALTH, EMPTY_STARTUP_RECOVERY, GatewayHealth, GatewaySubsystem, getPanelId(), getPanelProps() (+15 more)
...
Cohesion: 0.19
Nodes (6): AgentCoordinator, AgentInstance, appendAgentRunEvent(), DEFAULT_AGENTS, stringifyRunPayload(), EngineConfig
...
Cohesion: 0.24
Nodes (8): clean_log_text(), emit_protocol_log(), LiveCapture, make_execution_log(), now_ms(), Write the protocol response while keeping late library stdout noise hidden., record_execution_log(), write_json_response()
...
Cohesion: 0.28
Nodes (9): bridge_textual_tool_call(), _decode_textual_tool_payloads(), _decode_tool_arguments(), _inferred_textual_tool_call(), _named_textual_tool_call(), _openai_tool_definitions(), Any, Turn strict JSON tool-call text into the native structure CrewAI executes. (+1 more)
...
Cohesion: 0.05
Nodes (77): claude_code_send(), crew_provider_models_list(), CrewProviderModelsRequest, CrewProviderModelsResponse, default_crew_execution_subject(), default_crew_governance_mode(), default_crew_output_mode(), desktop_capture_primary_annotated_screenshot() (+69 more)
...
Cohesion: 0.05
Nodes (60): CATEGORY_LABELS, CATEGORY_ORDER, CommandPalette(), ConnectorPanel(), CoworkQuickPrompts(), CoworkQuickPromptsProps, GuidedOnboarding(), GuidedOnboardingProps (+52 more)
...
### Community 203 - "CreateDirectoryTool"
Cohesion: 0.70
Nodes (5): expected_edit_artifact_paths(), expected_office_artifact_paths(), expected_required_artifact_paths(), missing_required_artifacts(), Path
...
### Community 211 - "StartupRecoveryReport"
Cohesion: 0.50
...
Cohesion: 0.05
Nodes (43): FeaturesView(), isWorkbenchTab(), TABS, WorkbenchTab, ClaudeMcpServer, exampleJson(), McpCallResponse, McpProbeResponse (+35 more)
...
## Knowledge Gaps
- **1280 isolated node(s):** `ProductSurface`, `PRODUCT_SURFACES`, `VIEWPORTS`, `name`, `private` (+1275 more)
...
- **Why does `Database` connect `globalSearch.ts` to `Result`, `lib.rs`, `String`, `String`, `chatStore.ts`, `LeftSidebar.tsx`, `sensitive_data.rs`, `gateway_health`, `getToolDefinitions`, `RunPanel.tsx`, `RequestContext`, `WorkTaskRow`, `memoryStore.ts`, `terminal_backends.rs`, `StartupRecoveryReport`, `memory_engine.rs`, `skill_engine.rs`, `5.3 Plan-, Approval- und Task-UI`, `insights.rs`, `workTasksStore.ts`, `Architektur`?**
  _High betweenness centrality (0.074) - this node is a cross-community bridge._
- **Why does `CoworkView()` connect `CoworkView.tsx` to `7. Desktop- und Fensterverhalten`, `crewStore.ts`, `gateway_health`, `App.tsx`, `Option`, `gateway_health`, `Vec`, `duckduckgo-websearch-server.mjs`, `workTaskCrewRuntime.ts`, `5.5 Settings-Ansicht`, `useConfigStore`, `audit_service.rs`, `webSearchSources.ts`, `projectStore.ts`, `chatStore.ts`?**
...
- **Should `Result` be split into smaller, more focused modules?**
  _Cohesion score 0.03812316715542522 - nodes in this community are weakly interconnected._

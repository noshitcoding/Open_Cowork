# Graph Report - Open_Cowork  (2026-07-11)

## Corpus Check
- 282 files · ~288,874 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4539 nodes · 11680 edges · 188 communities (171 shown, 17 thin omitted)
...
- [[_COMMUNITY_FeaturesView.tsx|FeaturesView.tsx]]
...
- [[_COMMUNITY_RecordingAuditSink|RecordingAuditSink]]
- [[_COMMUNITY_NoopEventSink|NoopEventSink]]
...
- [[_COMMUNITY_registerAllBuiltinTools|registerAllBuiltinTools]]
...
- `integrity_report()` --calls--> `verify_audit_integrity()`  [INFERRED]
  app/src-tauri/src/audit.rs → app/src-tauri/src/audit_service.rs
- `verified_tail()` --calls--> `verified_audit_tail()`  [INFERRED]
  app/src-tauri/src/audit.rs → app/src-tauri/src/audit_service.rs
- `create_key_if_allowed()` --calls--> `create()`  [INFERRED]
  app/src-tauri/src/audit_service.rs → app/src-tauri/src/support_bundle.rs
...
### Community 0 - "Result"
Cohesion: 0.04
Nodes (138): backend_delete(), backend_ensure_local(), backend_exec(), backend_list(), backend_upsert(), claude_code_stop(), credential_delete(), credential_get() (+130 more)

### Community 1 - "lib.rs"
Cohesion: 0.04
Nodes (84): apply_provider_headers(), build_provider_chat_urls(), build_provider_model_urls(), command_contains_path_traversal(), connector_test_reachability(), ConnectorReachabilityRequest, ConnectorReachabilityResponse, crew_provider_health_check() (+76 more)
...
### Community 4 - "String"
Cohesion: 0.04
Nodes (83): crew_definition_upsert(), crew_role_binding_list(), crew_role_binding_upsert(), crew_stop(), CrewDefinitionUpsertRequest, CrewMemoryEntryPayload, CrewMemoryPayload, CrewRoleBindingUpsertRequest (+75 more)
...
Cohesion: 0.04
Nodes (100): AskUserOption, AskUserPromptModel, buildChatExportPayload(), buildEngineUserInput(), buildProjectInstructionsPromptContext(), buildProjectLinkPromptContext(), ChatExportFormat, clipVerboseText() (+92 more)

### Community 7 - "AppHandle"
Cohesion: 0.07
Nodes (54): ArtifactExportRow, ArtifactVersionRow, authorize_worker_sandbox_source(), build_exec_command_text(), crew_runs_list(), CrewRunHistoryRow, detect_dangerous_shell_pattern(), emit_exec_chunk() (+46 more)
...
### Community 10 - "Option"
Cohesion: 0.12
Nodes (28): normalizeSessions(), normalizeSessionSummary(), SessionLike, SessionSearchPanel(), sessionRecord, sessionSummary, toNumber(), SessionRecord (+20 more)
...
Cohesion: 0.07
Nodes (50): CATEGORY_LABELS, CATEGORY_ORDER, CommandPalette(), Layout(), buildTaskSidebarSummary(), formatWorkTaskStatus(), getTaskSidebarTitle(), getThreadDropTarget() (+42 more)

### Community 14 - "index.ts"
Cohesion: 0.08
Nodes (51): streamMessages(), PermissionDecision, getAllTools(), accumulateUsage(), AgentToolProgress, AssistantMessage, AttachmentMessage, BashProgress (+43 more)
...
Cohesion: 0.07
Nodes (73): TaskCreatePanel(), TaskCreatePanelProps, TaskDetailPane(), TaskDetailPaneProps, TaskProjectContext, TaskListPane(), TaskListPaneProps, baseTask (+65 more)
...
Cohesion: 0.06
Nodes (13): CrewApprovalRow, CrewDefinitionRow, CrewRoleBindingRow, Database, map_worker_sandbox_row(), MemoryEntryRow, Option, SessionRow (+5 more)

### Community 21 - "safeInvoke"
Cohesion: 0.05
Nodes (40): ConnectorPanel(), formatDateTime(), getTabLabel(), MemoryPanel(), MemoryTab, randomId(), truncateText(), ActiveTab (+32 more)
...
### Community 24 - "String"
Cohesion: 0.07
Nodes (15): CrewDefinitionVersionRow, CrewRunEventRow, EngineRunCheckpointRow, LearningOutcomeRow, ManagedProcessRow, MemoryProviderRow, PersonalityRow, RpcPipelineRow (+7 more)
...
Cohesion: 0.08
Nodes (43): active_toolset_inference_detects_custom_edits(), backend_file_mutations_respect_the_active_toolset_policy(), build_policy_tool_states(), build_toolset_policy(), claude_code_list_commands(), claude_code_list_tools(), crew_run_events_list(), crew_tool_allowed_by_flags() (+35 more)
...
Cohesion: 0.11
Nodes (30): canonical_policy_tool_id(), claude_code_send_stream(), configure_pdfium_search_paths(), deny_rule_errors_do_not_echo_sensitive_targets(), document_render_preview(), enforce_file_tool_policy(), enforce_tool_policy(), ensure_run_file_access() (+22 more)

### Community 31 - "mcp.rs"
Cohesion: 0.17
Nodes (39): mcp_probe(), call_tool(), format_call_result(), McpCallRequest, McpCallResponse, McpError, McpProbeResponse, McpRuntimeServerStatus (+31 more)
...
Cohesion: 0.05
Nodes (31): getAllCommands(), AgentCoordinator, AgentInstance, appendAgentRunEvent(), DEFAULT_AGENTS, stringifyRunPayload(), EngineBackend, EngineConfig (+23 more)
...
Cohesion: 0.07
Nodes (31): ProcessPanel(), emptyForm, formatDateTime(), getRunModeLabel(), getTabLabel(), randomId(), runModeLabels, SkillPanel() (+23 more)
...
Cohesion: 0.15
Nodes (22): hydrateMcpServer(), initializeCredentialVault(), initializeCredentialVaultOnce(), migrateOrRead(), resetCredentialInitializationForTests(), SENTINELS, connectorLocator(), CredentialReadResponse (+14 more)

### Community 44 - "Vec"
Cohesion: 0.05
Nodes (46): CrewExecutionLogRow, CrewExecutionResponse, CrewHistoryPanel(), CrewRunEventRow, CrewRunHistoryRow, formatTimestamp(), Props, baseAgent (+38 more)
...
Cohesion: 0.23
Nodes (8): audit_service_records_denial_event_without_tauri_runtime(), audit_service_records_success_event_without_tauri_runtime(), AuditService, AuditService<S>, Into, S, Self, ServiceResult

### Community 53 - "projectStore.ts"
Cohesion: 0.06
Nodes (49): AddProjectResourceInput, addUniqueResources(), DbProject, DbProjectResource, DeleteProjectOptions, generateId(), getEnabledProjectAttachments(), getEnabledProjectLinks() (+41 more)

### Community 54 - "db.rs"
Cohesion: 0.10
Nodes (17): streamOllamaMessagesMock, QueryEngine, chunk(), DEFAULT_ORCHESTRATOR_CONFIG, ToolExecutionEvent, ToolExecutionResult, ToolOrchestrator, ToolOrchestratorConfig (+9 more)
...
Cohesion: 0.07
Nodes (34): getSessionLabel(), getStatusLabel(), TerminalDock(), TerminalDockProps, xtermInstances, createSession(), invokeMock, runAiCommandMock (+26 more)
...
Cohesion: 0.16
Nodes (29): a_new_service_instance_continues_the_persisted_chain(), archive_path(), audit_file_path(), audit_rotation_keeps_only_the_configured_archives(), AuditIntegrityEnvelope, calculate_mac(), canonical_record(), create_key_if_allowed() (+21 more)

### Community 64 - ".open_in_memory"
Cohesion: 0.12
Nodes (8): delete_thread_cascades(), engine_runs_capture_gateway_metadata(), messages_round_trip(), migration_creates_tables(), project_thread_assignment_is_exclusive_and_delete_can_remove_threads(), ProjectResourceRow, ProjectRow, projects_resources_and_threads_round_trip()
...
Cohesion: 0.13
Nodes (32): AuditIntegrityReport, AuditIntegrityStatus, credential_marker_detects_complete_signed_history_deletion(), reconcile_history_marker(), serialized_integrity_report_exposes_only_fixed_path_free_fields(), signed_history_fails_closed_when_its_marker_cannot_be_persisted(), diagnostic_label(), audit_integrity() (+24 more)

### Community 69 - "globalSearch.ts"
Cohesion: 0.10
Nodes (18): AskQuestionOption, ChatState, CrewLiveEntryCategory, CrewLiveSeverity, CrewLiveStatus, DbMessage, getActiveThread(), isTauriRuntime() (+10 more)
...
Cohesion: 0.25
Nodes (23): append_test_event(), append_with_key(), AuditVerificationState, decode_mac(), deletion_inside_the_retained_chain_is_detected(), legacy_prefix_can_be_migrated_but_remains_degraded(), legacy_record_after_signed_history_is_detected(), malformed_complete_record_is_detected() (+15 more)
...
Cohesion: 0.07
Nodes (14): Crew Task Import Control, Task Create Panel, Task Detail Pane, Task List Pane, Task Run Toolbar, Task Scheduler Panel, Crew Task Import Flow, WorkTask Run And Schedule Flow (+6 more)
...
Cohesion: 0.11
Nodes (17): clearStorageKey(), getVolatileMemoryProviders(), getVolatileToolGateways(), LegacyMemoryProviderConfig, LegacyToolGatewayConfig, migrateLegacyMemoryProviderConfigs(), migrateLegacyToolGatewayConfigs(), parseArray() (+9 more)
...
Cohesion: 0.13
Nodes (24): audit_event(), capture_screenshot_for_display_payload(), fs_watch_list(), fs_watch_stop(), local_docs_mcp_call(), local_screenshot_mcp_call(), mcp_call_tool(), parse_bool_tool_arg() (+16 more)
...
Cohesion: 0.08
Nodes (41): add_column_if_missing(), audit_event_insert(), configure_connection(), connection_pragmas_enforce_integrity_and_contention_policy(), corrupt_database_files_and_invalid_data_directories_are_rejected(), create_pre_migration_backup(), current_schema_version(), database_error() (+33 more)
...
### Community 109 - "registry.terminal.test.ts"
Cohesion: 0.33
...
Cohesion: 0.04
Nodes (57): ExternalProviderHealthCheckResult, ExternalProviderModelsResult, LlmProfilesPanel(), modelSuffix(), parseNumericInput(), ProfileHealthState, ProfileModelsState, PROVIDER_LABELS (+49 more)
...
### Community 133 - "attachmentPromptContext.ts"
Cohesion: 0.40
...
### Community 143 - "modelCapabilities.ts"
Cohesion: 0.50
...
Cohesion: 0.27
Nodes (10): autoSaveSession(), DbSessionRow, deleteSession(), endSession(), generateSessionTitle(), listSessions(), loadSession(), parseDbDate() (+2 more)

### Community 160 - "validateProductDoc"
Cohesion: 0.67
Nodes (3): ELEMENT_FIELDS, frontmatterHasList(), validateProductDoc()

### Community 174 - "TerminalDock.tsx"
Cohesion: 0.05
Nodes (47): App(), AppRoutes(), BackendPolicyState, confirmAppClose(), CoworkView, CrewView, FeaturesView, hasRunningWork() (+39 more)

### Community 176 - "followUpPrompt.ts"
Cohesion: 0.46
Nodes (6): ClarificationContext, CLARIFYING_QUESTION_PATTERNS, FollowUpPromptMessage, inferClarificationContext(), isLikelyClarifyingQuestion(), isLikelyShortFollowUpAnswer()

### Community 177 - "FeaturesView.tsx"
Cohesion: 0.33
Nodes (6): FeatureItem, FEATURES, FeatureStatus, FeaturesView(), STATUS_LABELS, statusClass()

### Community 178 - "createDesktopscreenshotAttachment"
Cohesion: 0.33
...
Cohesion: 0.08
Nodes (26): EngineRunRow, scheduled_run_claim_prevents_overlap_and_completion_updates_the_same_row(), startup_recovery_reconciles_active_state_after_reopen_and_is_idempotent(), StartupRecoveryReport, bounded_json_stays_valid_and_redacted(), bounds_utf8_text_without_splitting_characters(), is_sensitive_key(), normalized_key() (+18 more)

### Community 181 - "RecordingAuditSink"
Cohesion: 0.33
Nodes (6): RecordingAuditSink, Mutex, Vec, AuditSink, Send, Sync

### Community 182 - "NoopEventSink"
Cohesion: 0.29
...
### Community 184 - "5.5 Settings-Ansicht"
Cohesion: 0.50
...
## Knowledge Gaps
- **1134 isolated node(s):** `name`, `private`, `version`, `description`, `type` (+1129 more)
...
- **Why does `Database` connect `useConfigStore` to `Result`, `lib.rs`, `String`, `AppHandle`, `gateway_health`, `String`, `configStore.ts`, `chatStore.ts`, `sensitive_data.rs`, `crew_provider_health_check`, `.open_in_memory`, `RequestContext`, `terminal_backends.rs`, `memory_engine.rs`, `useTerminalStore`, `skill_engine.rs`, `process_manager.rs`, `5.3 Plan-, Approval- und Task-UI`, `insights.rs`, `registry.terminal.test.ts`, `WorkTaskRow`?**
  _High betweenness centrality (0.172) - this node is a cross-community bridge._
- **Why does `Command` connect `index.ts` to `lib.rs`, `crew_python_bridge.rs`, `claude_code_bridge.rs`, `terminal_backends.rs`, `registry.ts`, `mcp.rs`?**
  _High betweenness centrality (0.167) - this node is a cross-community bridge._
- **Why does `CredentialLocator` connect `memoryStore.ts` to `Result`, `LeftSidebar.tsx`?**
...
- **Should `Result` be split into smaller, more focused modules?**
  _Cohesion score 0.04030466518565535 - nodes in this community are weakly interconnected._

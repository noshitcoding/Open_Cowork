# Graph Report - Open_Cowork  (2026-07-12)

## Corpus Check
- 299 files · ~302,525 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4655 nodes · 11943 edges · 196 communities (180 shown, 16 thin omitted)
...
- [[_COMMUNITY_ensure_windows_desktop_support|ensure_windows_desktop_support]]
...
- [[_COMMUNITY_crew_approval_resolve|crew_approval_resolve]]
...
- `sanitize_details()` --calls--> `redact_and_bound_json_text()`  [INFERRED]
  app/src-tauri/src/audit_service.rs → app/src-tauri/src/sensitive_data.rs
...
### Community 0 - "Result"
Cohesion: 0.05
Nodes (141): Database, TerminalBackendRow, ArtifactExportRow, authorize_worker_sandbox_source(), backend_delete(), backend_ensure_local(), backend_exec(), backend_list() (+133 more)
...
Cohesion: 0.04
Nodes (72): repository, type, url, CrewControlPlanePanel(), formatTimestamp(), Props, CrewGovernancePanel(), formatApprovalStatus() (+64 more)
...
### Community 4 - "String"
Cohesion: 0.03
Nodes (109): crew_stop(), CrewMemoryEntryPayload, CrewMemoryPayload, CrewStopRequest, CrewUserProfilePayload, db_list_messages(), db_list_steps(), db_list_tasks() (+101 more)
...
Cohesion: 0.06
Nodes (39): ArtifactVersionRow, build_exec_command_text(), crew_role_binding_list(), crew_role_binding_upsert(), crew_runs_list(), CrewRoleBindingUpsertRequest, CrewRunHistoryRow, db_save_thread() (+31 more)
...
### Community 11 - "tr"
Cohesion: 0.09
Nodes (35): aggregate_gateway_status(), build_local_gateway_subsystems(), check_audit_writable(), claude_code_send_stream(), configure_pdfium_search_paths(), execute_task(), export_save_text_file(), fs_generate_pro_outputs() (+27 more)
...
Cohesion: 0.11
Nodes (16): Actor, ActorId, ActorKind, ActorRole, anonymous_fixture_has_no_actor_id(), context_serializes_with_camel_case_fields(), local_default_context_needs_no_network_config(), RequestId (+8 more)
...
Cohesion: 0.06
Nodes (33): sessionRecord, sessionSummary, getAllCommands(), EngineBackend, CrewTaskMessageParams, autoSaveSession(), createSession(), DbSessionRow (+25 more)
...
Cohesion: 0.07
Nodes (30): FeaturesView(), isWorkbenchTab(), TABS, WorkbenchTab, ProcessPanel(), emptyForm, formatDateTime(), getRunModeLabel() (+22 more)
...
Cohesion: 0.06
Nodes (42): claude_code_list_commands(), claude_code_list_tools(), default_policy_enabled_tool_ids_vec(), desktop_launch_app(), DesktopLaunchRequest, DesktopLaunchResponse, filter_runtime_instructions_for_cwd(), fs_list_allowed_folders() (+34 more)

### Community 43 - "toolOrchestrator.ts"
Cohesion: 0.17
Nodes (18): BackendWorkTask, mapBackendWorkTask(), mergeTaskPatch(), migrateLegacyStorageToSqlite(), normalizeRunner(), normalizeStatus(), normalizeTask(), optionalString() (+10 more)
...
Cohesion: 0.19
Nodes (18): OllamaEngineConfig, applyToolResultBudget(), autoCompact(), createTokenBudget(), estimateConversationTokens(), estimateTokens(), fallbackCompact(), generateToolUseSummary() (+10 more)

### Community 52 - "audit_service.rs"
Cohesion: 0.06
Nodes (76): TaskCreatePanel(), TaskCreatePanelProps, TaskDetailPane(), TaskDetailPaneProps, TaskProjectContext, TaskListPane(), TaskListPaneProps, baseTask (+68 more)
...
### Community 54 - "db.rs"
Cohesion: 0.10
Nodes (17): AskQuestionOption, ChatMessage, ChatState, CrewLiveSeverity, CrewLiveStatus, DbMessage, getActiveThread(), isTauriRuntime() (+9 more)
...
Cohesion: 0.05
Nodes (91): active_toolset_inference_detects_custom_edits(), backend_file_mutations_respect_the_active_toolset_policy(), build_crew_memory_query(), build_effective_crew_tool_ids(), build_policy_tool_states(), build_toolset_policy(), canonical_policy_tool_id(), collect_crew_governance_payload() (+83 more)
...
Cohesion: 0.19
Nodes (18): asBoolean(), asNullableString(), asNumber(), asRecord(), asString(), asTimestampString(), EngineRunCheckpointRow, EngineRunRow (+10 more)

### Community 63 - "QueryEngine"
Cohesion: 0.07
Nodes (21): CrewExecutionLogRow, CrewExecutionResponse, CrewHistoryPanel(), CrewRunEventRow, CrewRunHistoryRow, formatTimestamp(), Props, GuidedOnboarding() (+13 more)
...
Cohesion: 0.05
Nodes (105): append_audit_event(), integrity_report(), Option, Path, PathBuf, Result, String, Value (+97 more)
...
Cohesion: 0.15
Nodes (20): NoopAuditSink, ClientPlatform, RequestContext, RequestOrigin, DateTime, Option, Utc, anonymous_context() (+12 more)
...
Cohesion: 0.05
Nodes (60): ConnectorPanel(), buildTaskSidebarSummary(), formatWorkTaskStatus(), getTaskSidebarTitle(), getThreadDropTarget(), isAbsolutePath(), LeftSidebar(), PointerThreadDrag (+52 more)
...
Cohesion: 0.15
Nodes (10): engine_runs_capture_gateway_metadata(), EngineRunArtifactRow, EngineRunEventRow, EngineRunRow, InsightsEventRow, map_engine_run_artifact_row(), map_engine_run_event_row(), map_engine_run_row() (+2 more)
...
Cohesion: 0.04
Nodes (64): CrewRuntimePanel(), formatTimestamp(), hasTauriRuntimeMock, baseAgent, hasTauriRuntimeMock, safeInvokeMock, formatDateTime(), getTabLabel() (+56 more)
...
### Community 139 - "pipelineStore.ts"
Cohesion: 0.09
Nodes (26): ModelSwitcher(), EMPTY_FORM, PersonalityEditor(), PersonalityForm, PersonalitySelector(), randomId(), ROLE_OPTIONS, toForm() (+18 more)
...
Cohesion: 0.57
Nodes (3): AuditService<S>, Into, ServiceResult
...
### Community 174 - "ensure_windows_desktop_support"
Cohesion: 0.29
Nodes (6): EventSink, NoopEventSink, Send, ServiceResult, Sync, noop_event_sink()

### Community 175 - "file-access-policy.md"
Cohesion: 0.16
...
### Community 181 - "LlmProfilesPanel.tsx"
Cohesion: 0.29
...
Cohesion: 0.08
Nodes (36): audit_event(), capture_screenshot_for_display_payload(), chat_turn(), chat_turn_stream(), chat_turn_stream_cancel(), ChatStreamRegistry, ChatTurnRequest, detect_crew_cycle() (+28 more)
...
### Community 184 - "crew_approval_resolve"
Cohesion: 0.33
...
### Community 186 - "normalizeDesktopCoordinateSpace"
Cohesion: 0.35
...
### Community 191 - "5.2 Cowork-Hauptansicht"
Cohesion: 0.40
...
### Community 192 - "5.3 Plan-, Approval- und Task-UI"
Cohesion: 0.40
...
### Community 194 - "7. Desktop- und Fensterverhalten"
Cohesion: 0.50
...
### Community 195 - "9. Visuelle und textliche Anforderungen"
Cohesion: 0.50
Nodes (4): 9. Visuelle und textliche Anforderungen, UI-100 Design System, UI-101 Dichte und Ruhe, UI-102 Sprache und Mikrotexte

## Knowledge Gaps
- **1161 isolated node(s):** `ProductSurface`, `PRODUCT_SURFACES`, `VIEWPORTS`, `name`, `private` (+1156 more)
...
- **Why does `Command` connect `index.ts` to `crew_python_bridge.rs`, `claude_code_bridge.rs`, `terminal_backends.rs`, `ChatTurnRequest`, `registry.ts`, `mcp.rs`?**
  _High betweenness centrality (0.202) - this node is a cross-community bridge._
- **Why does `Database` connect `Result` to `SettingsView.tsx`, `String`, `work_task_upsert`, `AppHandle`, `tr`, `useConfigStore`, `gateway_health`, `String`, `LeftSidebar.tsx`, `sensitive_data.rs`, `ChatTurnRequest`, `crew_approval_resolve`, `crew_provider_health_check`, `.open_in_memory`, `RequestContext`, `terminal_backends.rs`, `memory_engine.rs`, `SkillPanel.tsx`, `skill_engine.rs`, `5.3 Plan-, Approval- und Task-UI`, `insights.rs`, `gateway_health`, `WorkTaskRow`?**
  _High betweenness centrality (0.185) - this node is a cross-community bridge._
- **Why does `CredentialLocator` connect `memoryStore.ts` to `taskStore.ts`, `Result`?**
...
- **Should `Result` be split into smaller, more focused modules?**
  _Cohesion score 0.05294176405953451 - nodes in this community are weakly interconnected._
...
- **Should `crewStore.ts` be split into smaller, more focused modules?**
  _Cohesion score 0.035955056179775284 - nodes in this community are weakly interconnected._
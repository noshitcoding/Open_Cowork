# Graph Report - Open_Cowork  (2026-07-10)

## Corpus Check
- 280 files · ~282,522 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4458 nodes · 11385 edges · 178 communities (162 shown, 16 thin omitted)
...
1. `Database` - 361 edges
2. `tr()` - 100 edges
3. `CoworkView()` - 75 edges
4. `safeInvoke()` - 54 edges
...
- `mcp_runtime_start()` --calls--> `runtime_start_server()`  [INFERRED]
...
### Community 0 - "Result"
Cohesion: 0.04
Nodes (143): Database, ToolGatewayRow, ArtifactExportRow, backend_delete(), backend_ensure_local(), backend_exec(), backend_list(), backend_upsert() (+135 more)

### Community 1 - "lib.rs"
Cohesion: 0.10
Nodes (32): apply_provider_headers(), build_provider_chat_urls(), build_provider_model_urls(), connector_test_reachability(), ConnectorReachabilityRequest, ConnectorReachabilityResponse, crew_provider_health_check(), crew_provider_models_list() (+24 more)
...
Cohesion: 0.03
Nodes (61): agentTool, askUserTool, AskUserToolInput, bashTool, copyPathTool, createDirectoryTool, deleteFileTool, DesktopActionResponse (+53 more)

### Community 4 - "String"
Cohesion: 0.03
Nodes (105): decode_html_entities(), default_crew_execution_subject(), default_crew_governance_mode(), default_crew_output_mode(), desktop_capture_primary_annotated_screenshot(), desktop_capture_primary_display(), desktop_capture_primary_display_with_overlay(), desktop_capture_primary_screenshot() (+97 more)
...
Cohesion: 0.06
Nodes (52): AskUserOption, AskUserPromptModel, buildChatExportPayload(), buildEngineUserInput(), buildProjectInstructionsPromptContext(), buildProjectLinkPromptContext(), ChatExportFormat, clipVerboseText() (+44 more)

### Community 7 - "AppHandle"
Cohesion: 0.06
Nodes (46): ArtifactVersionRow, build_exec_command_text(), crew_approval_create(), crew_approval_list(), crew_approval_resolve(), crew_runs_list(), CrewApprovalCreateRequest, CrewApprovalResolveRequest (+38 more)
...
### Community 10 - "Option"
Cohesion: 0.06
Nodes (51): normalizeSessions(), normalizeSessionSummary(), SessionLike, SessionSearchPanel(), toNumber(), SessionSummary, AskQuestionOption, ChatMessage (+43 more)
...
Cohesion: 0.07
Nodes (48): App(), AppRoutes(), BackendPolicyState, confirmAppClose(), CoworkView, CrewView, FeaturesView, hasRunningWork() (+40 more)

### Community 14 - "index.ts"
Cohesion: 0.09
Nodes (51): streamMessages(), PermissionDecision, accumulateUsage(), AgentToolProgress, AssistantMessage, AttachmentMessage, BashProgress, ContentBlockDelta (+43 more)
...
Cohesion: 0.04
Nodes (9): CrewApprovalRow, CrewDefinitionRow, CrewRoleBindingRow, map_worker_sandbox_row(), MemoryEntryRow, Option, SkillRow, WorkerSandboxRow (+1 more)
...
Cohesion: 0.08
Nodes (28): baseAgent, safeInvokeMock, ModelSwitcher(), EMPTY_FORM, PersonalityEditor(), PersonalityForm, PersonalitySelector(), randomId() (+20 more)
...
Cohesion: 0.10
Nodes (55): audit_event(), audit_log_path(), authorize_worker_sandbox_source(), claude_code_send_stream(), deny_rule_errors_do_not_echo_sensitive_targets(), document_render_preview(), enforce_file_tool_policy(), enforce_tool_policy() (+47 more)
...
Cohesion: 0.06
Nodes (33): sessionRecord, sessionSummary, getAllCommands(), EngineBackend, CrewTaskMessageParams, autoSaveSession(), DbSessionRow, deleteSession() (+25 more)
...
Cohesion: 0.12
Nodes (20): CATEGORY_LABELS, CATEGORY_ORDER, CommandPalette(), ProcessPanel(), buildAllCommands(), CommandRegistryState, getSlashCommandSuggestions(), SlashCommand (+12 more)
...
Cohesion: 0.14
Nodes (28): formatDate(), getProjectTitleForThread(), ProjectView(), readDraggedThreadId(), getProjectForThread(), blobToDataUrl(), createAttachmentId(), createInlineImageAttachment() (+20 more)
...
Cohesion: 0.05
Nodes (48): ConnectorPanel(), FeatureItem, FEATURES, FeatureStatus, FeaturesView(), STATUS_LABELS, statusClass(), ContextPanel() (+40 more)

### Community 43 - "toolOrchestrator.ts"
Cohesion: 0.10
Nodes (12): streamOllamaMessagesMock, streamOllamaMessagesMock, chunk(), DEFAULT_ORCHESTRATOR_CONFIG, ToolExecutionEvent, ToolExecutionResult, ToolOrchestrator, ToolOrchestratorConfig (+4 more)

### Community 44 - "Vec"
Cohesion: 0.04
Nodes (59): CrewExecutionLogRow, CrewExecutionResponse, CrewHistoryPanel(), CrewRunEventRow, CrewRunHistoryRow, formatTimestamp(), Props, formatDateTime() (+51 more)
...
Cohesion: 0.11
Nodes (26): archive_path(), audit_rotation_keeps_only_the_configured_archives(), audit_service_records_denial_event_without_tauri_runtime(), audit_service_records_success_event_without_tauri_runtime(), AuditService, AuditService<S>, legacy_jsonl_service_preserves_existing_event_shape(), legacy_jsonl_service_redacts_secrets_before_writing() (+18 more)

### Community 53 - "projectStore.ts"
Cohesion: 0.09
Nodes (29): navigateMock, AddProjectResourceInput, addUniqueResources(), DbProject, DbProjectResource, DeleteProjectOptions, generateId(), getEnabledProjectAttachments() (+21 more)
...
Cohesion: 0.04
Nodes (102): active_toolset_inference_detects_custom_edits(), backend_file_mutations_respect_the_active_toolset_policy(), build_crew_memory_query(), build_effective_crew_tool_ids(), build_policy_tool_states(), build_toolset_policy(), canonical_policy_tool_id(), chat_turn_stream_cancel() (+94 more)
...
Cohesion: 0.21
Nodes (19): audit_tail(), bundle_is_whitelisted_manifested_and_contains_no_input_secrets(), BundleEntry, create(), Option, Path, Result, String (+11 more)
...
Cohesion: 0.17
Nodes (14): ExternalProviderHealthCheckResult, ExternalProviderModelsResult, LlmProfilesPanel(), modelSuffix(), parseNumericInput(), ProfileHealthState, ProfileModelsState, PROVIDER_LABELS (+6 more)
...
Cohesion: 0.07
Nodes (64): CredentialLocator, attach_process_tree(), configure_process_tree(), ProcessTreeGuard, Child, Option, Result, terminate_platform_tree() (+56 more)
...
Cohesion: 0.29
Nodes (16): AdminApprovalRequest, approve_and_start(), detect_admin_requirement(), list_process_statuses(), ProcessStartRequest, ProcessStartResult, ProcessStatusResult, Arc (+8 more)
...
Cohesion: 0.36
Nodes (6): CrewRuntimePanel(), formatTimestamp(), CrewRuntimeBootstrapResponse, CrewRuntimeState, CrewRuntimeStatus, useCrewRuntimeStore

### Community 87 - "chatProvider.ts"
Cohesion: 0.33
Nodes (3): TaskTemplate, TaskTemplateInput, TaskTemplatesState
...
Cohesion: 0.12
Nodes (25): capture_screenshot_for_display_payload(), fs_watch_list(), fs_watch_start(), fs_watch_stop(), local_screenshot_mcp_call(), parse_bool_tool_arg(), parse_i64_tool_arg(), parse_screenshot_region() (+17 more)
...
Cohesion: 0.07
Nodes (43): add_column_if_missing(), audit_event_insert(), configure_connection(), connection_pragmas_enforce_integrity_and_contention_policy(), corrupt_database_files_and_invalid_data_directories_are_rejected(), create_pre_migration_backup(), current_schema_version(), database_error() (+35 more)
...
Cohesion: 0.06
Nodes (52): ClaudeMcpServer, exampleJson(), McpCallResponse, McpProbeResponse, McpRuntimeServerStatus, McpTool, McpView(), parseEnv() (+44 more)
...
Cohesion: 0.18
Nodes (16): allowFolderAttachments(), AttachmentPromptBuildResult, buildAttachmentPromptContext(), collectSnippets(), extractQueryTerms(), ExtractTextLimitedResponse, FsAttachmentMetadataEntry, FsAttachmentMetadataResponse (+8 more)
...
### Community 181 - "ProjectView.tsx"
Cohesion: 0.67
Nodes (3): inferShellCwdFromCommand(), normalizeShellPath(), resolveShellNavigationTarget()

## Knowledge Gaps
- **1126 isolated node(s):** `name`, `private`, `version`, `description`, `type` (+1121 more)
...
- **Why does `Command` connect `index.ts` to `process_manager.rs`, `crew_python_bridge.rs`, `claude_code_bridge.rs`, `terminal_backends.rs`, `logStore.ts`, `registry.ts`, `mcp.rs`?**
  _High betweenness centrality (0.176) - this node is a cross-community bridge._
- **Why does `Database` connect `Result` to `String`, `AppHandle`, `useConfigStore`, `gateway_health`, `String`, `chatStore.ts`, `sensitive_data.rs`, `crew_provider_health_check`, `.open_in_memory`, `globalSearch.ts`, `RequestContext`, `terminal_backends.rs`, `logStore.ts`, `memory_engine.rs`, `useTerminalStore`, `skill_engine.rs`, `process_manager.rs`, `5.3 Plan-, Approval- und Task-UI`, `insights.rs`, `WorkTaskRow`?**
  _High betweenness centrality (0.159) - this node is a cross-community bridge._
- **Why does `CredentialLocator` connect `terminal_backends.rs` to `Result`, `workTasksStore.ts`?**
...
- **Should `Result` be split into smaller, more focused modules?**
  _Cohesion score 0.03807303807303807 - nodes in this community are weakly interconnected._

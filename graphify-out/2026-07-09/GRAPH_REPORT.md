# Graph Report - Open_Cowork  (2026-07-09)

## Corpus Check
- 263 files · ~269,134 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4222 nodes · 10686 edges · 184 communities (170 shown, 14 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 50 edges (avg confidence: 0.66)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `97fa0847`
...
- [[_COMMUNITY_attachmentPromptContext.ts|attachmentPromptContext.ts]]
- [[_COMMUNITY_compilerOptions|compilerOptions]]
...
- [[_COMMUNITY_engineStore.test.ts|engineStore.test.ts]]
...
- [[_COMMUNITY_crewRuntimeStore.ts|crewRuntimeStore.ts]]
...
- [[_COMMUNITY_append_audit_event|append_audit_event]]
- [[_COMMUNITY_Decisions|Decisions]]
...
- [[_COMMUNITY_run_powershell_script|run_powershell_script]]
...
1. `Database` - 354 edges
2. `tr()` - 97 edges
3. `CoworkView()` - 75 edges
4. `safeInvoke()` - 47 edges
5. `useConfigStore` - 43 edges
6. `QueryEngine` - 36 edges
7. `ServiceError` - 33 edges
8. `TasksView()` - 33 edges
9. `RequestContext` - 29 edges
10. `AuditEvent` - 26 edges
...
- `ollama_health_check()` --calls--> `check_health()`  [INFERRED]
  app/src-tauri/src/lib.rs → app/src-tauri/src/ollama.rs
- `mcp_runtime_stop()` --calls--> `runtime_stop_server()`  [INFERRED]
  app/src-tauri/src/lib.rs → app/src-tauri/src/mcp.rs
- `mcp_runtime_list()` --calls--> `runtime_list_servers()`  [INFERRED]
  app/src-tauri/src/lib.rs → app/src-tauri/src/mcp.rs
...
### Community 0 - "Result"
Cohesion: 0.05
Nodes (143): ArtifactExportRow, ArtifactVersionRow, audit_log_path(), authorize_worker_sandbox_source(), backend_delete(), backend_ensure_local(), backend_exec(), backend_upsert() (+135 more)
...
Cohesion: 0.04
Nodes (68): CrewControlPlanePanel(), formatTimestamp(), Props, CrewGovernancePanel(), formatApprovalStatus(), formatApprovalType(), formatTimestamp(), GOVERNANCE_MODES (+60 more)
...
### Community 4 - "String"
Cohesion: 0.04
Nodes (88): crew_stop(), CrewMemoryEntryPayload, CrewMemoryPayload, CrewStopRequest, CrewUserProfilePayload, db_list_messages(), db_list_steps(), db_list_tasks() (+80 more)
...
Cohesion: 0.05
Nodes (62): AskUserOption, AskUserPromptModel, buildChatExportPayload(), buildEngineUserInput(), buildProjectInstructionsPromptContext(), buildProjectLinkPromptContext(), ChatExportFormat, clipVerboseText() (+54 more)

### Community 7 - "AppHandle"
Cohesion: 0.11
Nodes (26): audit_event(), capture_screenshot_for_display_payload(), fs_watch_list(), fs_watch_start(), fs_watch_stop(), local_screenshot_mcp_call(), parse_bool_tool_arg(), parse_i64_tool_arg() (+18 more)

### Community 8 - "App.tsx"
Cohesion: 0.07
Nodes (34): App(), AppRoutes(), BackendPolicyState, confirmAppClose(), CoworkView, CrewView, FeaturesView, hasRunningWork() (+26 more)
...
Cohesion: 0.12
Nodes (12): AnthropicAPIError, APIContentBlock, APIMessage, APIToolDef, calculateCost(), COST_PER_MILLION, sampleMessage(), StreamCallbacks (+4 more)

### Community 13 - "Database"
Cohesion: 0.05
Nodes (14): CrewApprovalRow, CrewDefinitionRow, CrewRoleBindingRow, CrewRunEventRow, Database, map_worker_sandbox_row(), MemoryEntryRow, Option (+6 more)

### Community 14 - "index.ts"
Cohesion: 0.08
Nodes (55): streamMessages(), streamOllamaMessagesMock, PermissionDecision, chunk(), ToolOrchestrator, accumulateUsage(), AgentToolProgress, AssistantMessage (+47 more)
...
Cohesion: 0.14
Nodes (49): build_chat_messages(), build_chat_prompt(), build_chat_turn_response(), build_chat_turn_response_preserves_tool_calls(), build_http_client(), chat_turn(), chat_turn_stream(), chat_turn_with_tools() (+41 more)

### Community 17 - "workTaskCrewRuntime.ts"
Cohesion: 0.11
Nodes (47): TasksView(), buildCrewRunOutput(), createCrewStreamId(), handleCrewTaskMessage(), appendCrewLiveEntry(), applyCrewDefaultModel(), assignCrewAgentColor(), augmentCrewToolsForTask() (+39 more)
...
Cohesion: 0.15
Nodes (16): ConnectorPanel(), CATEGORIES, CategoryKey, EMPTY_GATEWAY_HEALTH, GatewayDiagnosticsPanel(), GatewayHealth, GatewaySubsystem, getPanelId() (+8 more)

### Community 21 - "safeInvoke"
Cohesion: 0.14
Nodes (17): CATEGORY_LABELS, CATEGORY_ORDER, CommandPalette(), ProcessPanel(), buildAllCommands(), CommandRegistryState, getSlashCommandSuggestions(), SlashCommand (+9 more)
...
### Community 24 - "String"
Cohesion: 0.07
Nodes (14): CrewDefinitionVersionRow, EngineRunCheckpointRow, LearningOutcomeRow, ManagedProcessRow, MemoryProviderRow, PersonalityRow, RpcPipelineRow, String (+6 more)
...
Cohesion: 0.05
Nodes (47): ExternalProviderHealthCheckResult, ExternalProviderModelsResult, LlmProfilesPanel(), modelSuffix(), parseNumericInput(), ProfileHealthState, ProfileModelsState, PROVIDER_LABELS (+39 more)
...
Cohesion: 0.15
Nodes (17): DefaultLlmProfileIds, OllamaConfig, getResolvedProvider(), CHAT_PROVIDER_LABELS, CHAT_PROVIDER_OPTIONS, ChatProviderContext, ChatProviderKind, collectProviderModels() (+9 more)

### Community 31 - "mcp.rs"
Cohesion: 0.15
Nodes (42): mcp_probe(), mcp_runtime_restart(), mcp_runtime_start(), call_tool(), format_call_result(), McpCallRequest, McpCallResponse, McpError (+34 more)
...
Cohesion: 0.06
Nodes (28): getAllCommands(), AgentCoordinator, AgentInstance, appendAgentRunEvent(), DEFAULT_AGENTS, stringifyRunPayload(), EngineBackend, EngineConfig (+20 more)

### Community 35 - "Option"
Cohesion: 0.05
Nodes (42): 10. Release-Gates, 11. Steuerung und Priorisierung, 12. Unmittelbar naechste Umsetzungsschritte, 1. Zielbild, 2. Verifizierter Ausgangspunkt, 3. Produkt- und Architekturentscheidungen, 4. Ziel-Domaenen und neue Vertraege, 5. Themengebiete und Feature-Plan (+34 more)

### Community 36 - "personalityStore.ts"
Cohesion: 0.05
Nodes (43): CrewExecutionLogRow, CrewExecutionResponse, CrewHistoryPanel(), CrewRunEventRow, CrewRunHistoryRow, formatTimestamp(), Props, baseAgent (+35 more)
...
Cohesion: 0.04
Nodes (63): Layout(), buildTaskSidebarSummary(), formatWorkTaskStatus(), getTaskSidebarTitle(), getThreadDropTarget(), isAbsolutePath(), LeftSidebar(), PointerThreadDrag (+55 more)

### Community 43 - "toolOrchestrator.ts"
Cohesion: 0.13
Nodes (10): SampleResult, toAPIToolDefs(), QueryEngine, getAllTools(), getToolDefinitions(), ContentBlock, ApprovalRequest, ApprovalResult (+2 more)

### Community 44 - "Vec"
Cohesion: 0.06
Nodes (43): backend_list(), claude_code_list_commands(), claude_code_list_tools(), crew_definition_versions_list(), default_policy_enabled_tool_ids_vec(), desktop_launch_app(), DesktopLaunchRequest, DesktopLaunchResponse (+35 more)
...
Cohesion: 0.07
Nodes (56): ANTHROPIC_MODELS, AnthropicConfig, listOllamaModels(), OllamaEngineConfig, sampleOllamaMessage(), createEngineConfig(), DEFAULT_CONFIG, fromPersistedConfig() (+48 more)

### Community 52 - "audit_service.rs"
Cohesion: 0.12
Nodes (21): audit_service_records_denial_event_without_tauri_runtime(), audit_service_records_success_event_without_tauri_runtime(), AuditService, AuditService<S>, legacy_jsonl_service_preserves_existing_event_shape(), LegacyAuditJsonlService, RecordingAuditSink, Into (+13 more)
...
### Community 54 - "db.rs"
Cohesion: 0.13
Nodes (17): add_column_if_missing(), engine_run_artifacts_round_trip_and_cascade(), engine_run_events_are_ordered_and_summarized(), engine_runs_capture_gateway_metadata(), EngineRunArtifactRow, EngineRunEventRow, EngineRunRow, insert_test_engine_run() (+9 more)
...
Cohesion: 0.04
Nodes (98): active_toolset_inference_detects_custom_edits(), build_crew_memory_query(), build_effective_crew_tool_ids(), build_policy_tool_states(), build_toolset_policy(), canonical_policy_tool_id(), collect_crew_governance_payload(), collect_crew_memory_payload() (+90 more)
...
Cohesion: 0.19
Nodes (22): asBoolean(), asNullableString(), asNumber(), asRecord(), asString(), asTimestampString(), EngineRunArtifactRow, EngineRunCheckpointRow (+14 more)

### Community 63 - "QueryEngine"
Cohesion: 0.08
Nodes (43): FeatureItem, FEATURES, FeatureStatus, FeaturesView(), STATUS_LABELS, statusClass(), ActiveTab, PipelinePanel() (+35 more)

### Community 64 - ".open_in_memory"
Cohesion: 0.11
Nodes (9): artifact_exports_round_trip(), artifact_versions_round_trip(), audit_event_insert(), delete_thread_cascades(), messages_round_trip(), migration_creates_tables(), policy_settings_round_trip(), PathBuf (+1 more)
...
Cohesion: 0.13
Nodes (13): formatDateTime(), getTabLabel(), MemoryPanel(), MemoryTab, randomId(), truncateText(), FrozenSnapshot, MemoryEntry (+5 more)

### Community 77 - "workTasksStore.ts"
Cohesion: 0.24
Nodes (11): buildPermissionContext(), checkToolPermission(), createAllowRule(), createAskRule(), createDenyRule(), getDefaultSecurityRules(), isPathAllowed(), matchesRule() (+3 more)

### Community 78 - "terminal_backends.rs"
Cohesion: 0.09
Nodes (53): Command, configure_process_tree(), Child, Result, terminate_platform_tree(), terminate_process_tree(), AdminApprovalRequest, approve_and_start() (+45 more)

### Community 79 - "INDEX.md"
Cohesion: 0.10
Nodes (10): Crew Task Import Control, Task Create Panel, Task Detail Pane, Task List Pane, Task Run Toolbar, Task Scheduler Panel, Crew Task Import Flow, WorkTask Run And Schedule Flow (+2 more)
...
Cohesion: 0.18
Nodes (15): BackendPipelineExecutionResult, getLocalGateway(), getLocalPipelines(), hasString(), isRecord(), normalizeRpcPipeline(), normalizeToolGatewayEntry(), ParsedPipelineStep (+7 more)
...
### Community 91 - "attachmentPromptContext.ts"
Cohesion: 0.33
Nodes (10): formatDate(), getProjectTitleForThread(), ProjectView(), readDraggedThreadId(), getProjectForThread(), extractFileAttachmentsFromFileList(), extractFileAttachmentsFromUriList(), fileUriToWindowsPath() (+2 more)
...
Cohesion: 0.11
Nodes (19): scripts, budgets:build, build, dev, dev:tauri, doctor, doctor:ci, i18n:audit (+11 more)

### Community 96 - "skill_engine.rs"
Cohesion: 0.24
Nodes (14): SkillRow, analyze_for_improvement(), analyze_for_skill_generation(), derive_skill_name(), match_skill_for_input(), Arc, Option, String (+6 more)

### Community 97 - "process_manager.rs"
Cohesion: 0.20
Nodes (4): project_thread_assignment_is_exclusive_and_delete_can_remove_threads(), ProjectResourceRow, ProjectRow, projects_resources_and_threads_round_trip()
...
### Community 99 - "agentCoordinator.ts"
Cohesion: 0.36
Nodes (8): desktop_capture_primary_annotated_screenshot(), desktop_capture_primary_display(), desktop_capture_primary_display_with_overlay(), desktop_capture_primary_screenshot(), desktop_coordinate_overlay_powershell(), desktop_primary_display(), DesktopDisplayInfo, DesktopScreenshotResponse
...
Cohesion: 0.09
Nodes (38): aggregate_gateway_status(), build_exec_command_text(), build_local_gateway_subsystems(), check_audit_writable(), claude_code_send_stream(), configure_pdfium_search_paths(), emit_exec_chunk(), exec_command() (+30 more)
...
Cohesion: 0.16
Nodes (19): desktop_click(), desktop_focus_window(), desktop_keypress(), desktop_list_windows(), desktop_list_windows_internal(), desktop_match_window(), desktop_move_mouse(), desktop_scroll() (+11 more)
...
### Community 111 - "engineStore.test.ts"
Cohesion: 0.15
...
### Community 114 - "webSearchSources.ts"
Cohesion: 0.35
...
Cohesion: 0.18
Nodes (10): description, license, name, private, repository, type, url, type (+2 more)
...
### Community 128 - "followUpPrompt.ts"
Cohesion: 0.42
...
### Community 130 - "crewRuntimeStore.ts"
Cohesion: 0.27
...
### Community 133 - "createDesktopscreenshotAttachment"
Cohesion: 0.33
...
### Community 134 - "append_audit_event"
Cohesion: 0.38
Nodes (6): append_audit_event(), Option, PathBuf, Result, String, Value
...
### Community 139 - ".list_artifact_exports"
Cohesion: 0.33
...
### Community 150 - "run_powershell_script"
Cohesion: 0.50
Nodes (4): crew_definition_list(), crew_definition_upsert(), CrewDefinitionUpsertRequest, CrewDefinitionRow
...
### Community 154 - "resolveShellNavigationTarget"
Cohesion: 0.67
Nodes (3): inferShellCwdFromCommand(), normalizeShellPath(), resolveShellNavigationTarget()

### Community 155 - "registry.terminal.test.ts"
Cohesion: 0.24
...
### Community 177 - "Current Architecture"
Cohesion: 0.29
...
### Community 180 - "5.2 Cowork-Hauptansicht"
Cohesion: 0.40
...
### Community 181 - "5.3 Plan-, Approval- und Task-UI"
Cohesion: 0.40
...
### Community 184 - "7. Desktop- und Fensterverhalten"
Cohesion: 0.50
...
### Community 185 - "9. Visuelle und textliche Anforderungen"
Cohesion: 0.50
Nodes (4): 9. Visuelle und textliche Anforderungen, UI-100 Design System, UI-101 Dichte und Ruhe, UI-102 Sprache und Mikrotexte

## Knowledge Gaps
- **1107 isolated node(s):** `name`, `private`, `version`, `description`, `type` (+1102 more)
...
- **Why does `Command` connect `terminal_backends.rs` to `crew_python_bridge.rs`, `AppHandle`, `claude_code_bridge.rs`, `index.ts`, `registry.ts`, `mcp.rs`?**
  _High betweenness centrality (0.310) - this node is a cross-community bridge._
- **Why does `suppress_command_window()` connect `AppHandle` to `crew_provider_health_check`, `gateway_health`, `terminal_backends.rs`?**
  _High betweenness centrality (0.189) - this node is a cross-community bridge._
- **Why does `Database` connect `Database` to `.open_in_memory`, `process_manager.rs`, `skill_engine.rs`, `Result`, `String`, `insights.rs`, `AppHandle`, `RequestContext`, `Option`, `gateway_health`, `Vec`, `terminal_backends.rs`, `memory_engine.rs`, `db.rs`, `run_powershell_script`, `String`, `crew_provider_health_check`, `WorkTaskRow`?**
...
- **Should `Result` be split into smaller, more focused modules?**
  _Cohesion score 0.04688269477001871 - nodes in this community are weakly interconnected._
...
- **Should `crewStore.ts` be split into smaller, more focused modules?**
  _Cohesion score 0.037756497948016415 - nodes in this community are weakly interconnected._